...
const fetchSuggestions = useCallback(
  async (query) => {
    ...
    const isDinSearch = /^\d{4,}$/.test(query);      // ✅ DIN (numbers only)
    ...
    // CIN logic SAME, DIN name ke through jayega
