                    ...
                    <div className="grid grid-cols-1 gap-8 text-center md:grid-cols-3">
                      ...
                      <div className="flex flex-col items-center">
                        <div className="mb-4 flex size-12 items-center justify-center rounded-full bg-muted-foreground">
                          <Phone className="size-6 text-primary-foreground" aria-hidden="true" />
                        </div>
                        <h3 className="mb-2 text-base font-bold uppercase">Phone</h3>
                        <p className="mb-2 text-sm text-muted-foreground">+91-9899600605</p>
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <p className="mb-2 text-sm text-muted-foreground">help@setindiabiz.com</p>
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <Link href={"https://api.whatsapp.com/send/?phone=919899600605"}>
                        <p className="mb-2 text-sm text-muted-foreground">Start Chat</p>
                        </Link> 
                      </div>
