...
const faqItems = [
  {
    ...
    answer:
      "SetIndiaBiz provides comprehensive data on registered companies, including basic profiles, director details, and more.",
  },
  {
    id: "faq2",
    question: "How do I search for companies on SetIndiaBiz?",
    answer:
      "You can search using the company name, Corporate Identification Number (CIN)",
  },
  {
    id: "faq3",
    question: "What is a CIN, and why is it important?",
    answer:
      "A CIN (Corporate Identification Number) is a unique 21-digit alphanumeric code assigned to companies registered in India. It's crucial for identifying and tracking companies.",
  },
  {
    id: "faq4",
    question: "Can I search for directors on SetIndiaBiz?",
    answer:
      "Yes, you can search for directors using their name or Director Identification Number (DIN) to find their associated companies and other details.",
  },
  {
    id: "faq5",
    question: "Is SetIndiaBiz's basic company profile free?",
    answer:
      "Yes, basic company profile information is generally available for free. More detailed data and features may require a subscription.",
  },
  {
    id: "faq6",
    question: "How often is the information on SetIndiaBiz updated?",
    answer:
      "We strive to update our database regularly based on information sourced from official registries like the Ministry of Corporate Affairs (MCA).",
  },
  {
    id: "faq7",
    question:
      "Can I find information about directors' qualifications on SetIndiaBiz?",
    answer: "No",
  },
  {
    id: "faq8",
    ...
    answer:
      "You can reach our support team via email at help@setindiabiz.com or through the contact form on our website.",
  },
  {
    id: "faq9",
    question: "What is the purpose of SetIndiaBiz?",
    answer:
      "SetIndiaBiz aims to simplify access to comprehensive and up-to-date information about Indian companies for businesses, professionals, and individuals.",
  },
  {
    id: "faq10",
    question: "Does SetIndiaBiz offer real-time company information?",
    answer:
      "While we update frequently, the data reflects the latest information available from official sources, which may not always be instantaneous real-time.",
  },
  {
    id: "faq11",
    question: "What types of companies can I find on SetIndiaBiz?",
    answer:
      "You can find information on various types of registered entities, including Private Limited Companies, Public Limited Companies, Limited Liability Partnerships (LLPs), and more.",
  },
  {
    id: "faq12",
    question:
      "Can I find information about Indian company directors on SetIndiaBiz?",
    answer:
      "Yes, SetIndiaBiz offers extensive search capabilities for directors registered in India, linking them to the companies they are associated with.",
  },
];
